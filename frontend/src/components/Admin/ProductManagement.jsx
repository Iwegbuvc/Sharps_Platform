...
const SUBCATEGORIES = {
  interiors: [
    ...
    { label: "Big Lights", value: "big-lights" },
    { label: "Small Lights", value: "small-lights" },
    ...
    { label: "Scents", value: "scents" },
    { label: "Other Artifacts", value: "other-artifacts" },
  ],
  clothing: [
    { label: "Shoes", value: "shoes" },
    { label: "Shirts", value: "shirts" },
    { label: "Bags", value: "bags" },
    { label: "Pants / Joggers", value: "pants-joggers" },
...
const AdminProducts = () => {
  ...
  const handleChange = (e) => {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]: type === "checkbox" ? checked : value,
      ...(name === "category" ? { sizes: [], subcategory: "" } : {}),
    }));
  };
